package.path = package.path .. ";C:\\Users\\stanl\\Documents\\LMU\\CS Language and Automata\\lmu-cmsi-3801-assignment1\\lua\\exercises.lua"



require "exercises.lua"
...
meaningful_line_count("whaevetra.txt")
